...
<body>
  ...
  <div class="tab-content" id="myTabContent">
    ...
    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
      <form method="post" action="Controllers/update_users_data_ctrl.php">
    ...
    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
      <form method="post" action="Controllers/update_exppro_data_ctrl.php">
        <div class="form-group">
          <label for="contrat">Type de contrat</label>
          <input type="text" class="form-control" id="contrat" placeholder="" name="type_contract_exp">
        </div>
        <div class="form-group">
    ...
    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
      <form method="post" action="Controllers/update_trainings_data_ctrl.php">
        <div class="form-group">
    ...
    <div class="tab-pane fade" id="skills" role="tabpanel" aria-labelledby="profile-tab">
      <form method="post" action="Controllers/update_skills_data_ctrl.php">
        <div class="form-group">
    ...
    <div class="tab-pane fade" id="realisations" role="tabpanel" aria-labelledby="profile-tab">
      <form method="post" action="Controllers/update_real_data_ctrl.php">
        <div class="form-group">
    ...
    <div class="tab-pane fade" id="activites" role="tabpanel" aria-labelledby="profile-tab">
      <form method="post" action="Controllers/update_activities_data_ctrl.php">
        <div class="form-group">
